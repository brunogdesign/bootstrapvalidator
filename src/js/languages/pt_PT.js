(function($) {
    $.fn.bootstrapValidator.i18n = $.extend(true, $.fn.bootstrapValidator.i18n, {
        base64: {
            'default': 'Por favor insira um valor base 64 válido'
        },
        between: {
            'default': 'Por favor insira um valor entre %s e %s',
            notInclusive: 'Por favor insira um valor entre %s e %s estritamente'
        },
        callback: {
        ...
        choice: {
            'default': 'Por favor insira um valor válido',
            less: 'Por favor escolha pelo menos %s opções',
            more: 'Por favor escolha no máximo %s opções',
            between: 'Por favor escolha entre %s a %s opções'
        },
        creditCard: {
